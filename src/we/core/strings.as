...
const String WE_MSG_REPORT_DEATH_HINT_PREFIX = "Type ";
const String WE_MSG_REPORT_DEATH_HINT_CMD = "/report ";
const String WE_MSG_REPORT_DEATH_HINT_REASON = " <reason>";
const String WE_MSG_REPORT_DEATH_HINT_SUFFIX = " into console to report ";
